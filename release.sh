...
EMAIL_SUBJECT="\${RELEASEVERSION} of JBoss JDG BOMs released, please merge with http://github.com/jboss-eap/jboss-bom, tag and add to JDG maven repo build"
# EAP team email To ?
...
JIRA_TO="pgier"
JIRA_SUMMARY="Upgrade jboss-jdg-bom project in JDG"
JIRA_DESCRIPTION="The \${RELEASEVERSION} version of the jboss-jdg-bom project has been released upstream. This needs to be merge with the eap branch and built for the eap Maven repo."
